...
*/
  ...
  // First Test
  def "1st Test: Setup Mapper object without fail"() {
    given:
  	  println "1st Test: Setup Mapper object without fail"
  ...
  // Second Test
  def "2nd Test: Setup Mapper object with fail"() {
    given:
  	println "2nd Test: Setup Mapper object with fail"
  ...
  // Third Test
  def "3rd Test: Setup Mapper and ask for map of all \${} fields"() {
    given:
      println "3rd Test: Setup Mapper and ask for map of all \${} fields"
      def s = '''Hello. My name is ${name} and live in ${country} with the name of ${name}.'''.toString();
