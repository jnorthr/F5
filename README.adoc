...
V1.1, Updated 25 Mar.2018, ReadMe Notes for F5 CopyTools
:sectanchors:
:sectlinks:
:icons: font
:allow-uri-read:
...
image:https://img.shields.io/travis/jnorthr/CopyTools.svg[Build Status (Travis CI), link=https://travis-ci.org/jnorthr/CopyTools]  image:https://img.shields.io/hexpm/l/plug.svg[Apache License, link=https://github.com/jnorthr/DoctorPepper/blob/master/LICENSE]
